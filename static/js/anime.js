...
hbtn.addEventListener('click',function(e){
    ...
    if(header__wrappers.classList.contains('mobil_app')){
        document.querySelector('.end_clock').style.display = 'none'
        document.querySelector('.click_look').style.display = 'block'
    }else{
        document.querySelector('.end_clock').style.display = 'block'
        document.querySelector('.click_look').style.display = 'none'
    }
